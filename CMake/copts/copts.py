...
COPT_VARS = {
    ...
    "BEANQUICK_LLVM_FLAGS":
        LLVM_BIG_WARNING_FLAGS + LLVM_DISABLE_WARNINGS_FLAGS,
    "BEANQUICK_LLVM_TEST_FLAGS":
        LLVM_TEST_DISABLE_WARNINGS_FLAGS,
    "BEANQUICK_CLANG_CL_FLAGS":
        (MSVC_BIG_WARNING_FLAGS + LLVM_DISABLE_WARNINGS_FLAGS + MSVC_DEFINES),
    "BEANQUICK_CLANG_CL_TEST_FLAGS":
        LLVM_TEST_DISABLE_WARNINGS_FLAGS,
    "BEANQUICK_MSVC_FLAGS":
    ...
    "BEANQUICK_RANDOM_HWAES_ARM64_FLAGS": ["-march=armv8-a+crypto"],
    "BEANQUICK_RANDOM_HWAES_ARM32_FLAGS": ["-mfpu=neon"],
    "BEANQUICK_RANDOM_HWAES_X64_FLAGS": [
        "-maes",
        "-msse4.1",
    ],
    "BEANQUICK_RANDOM_HWAES_MSVC_X64_FLAGS": [],
}
